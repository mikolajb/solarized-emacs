...
;;;;; dired-efap
     `(dired-efap-face ((,class (:box nil
                                      ...
                                      :weight bold))))
;;;;; diredp
     `(diredp-compressed-file-name ((,class (:foreground ,cyan))))
     `(diredp-compressed-file-suffix ((,class (:foreground ,base01))))
     `(diredp-date-time ((,class (:foreground ,yellow))))
     `(diredp-deletion-file-name ((,class (:foreground ,red :background ,base02))))
     `(diredp-deletion ((,class (:foreground ,red :weight bold))))
     `(diredp-dir-heading ((,class (:foreground ,base1 :background ,base02))))
     ...
     `(diredp-file-suffix ((,class (:foreground ,base01))))
     `(diredp-flag-mark-line ((,class (:foreground ,base1 :slant italic :background ,base02))))
     `(diredp-flag-mark ((,class (:foreground ,base1 :weight bold :background ,base02))))
     `(diredp-ignored-file-name ((,class (:foreground ,base01))))
     `(diredp-mode-line-flagged ((,class (:foreground ,orange))))
     `(diredp-mode-line-marked ((,class (:foreground ,orange))))
     `(diredp-no-priv ((,class (:foreground ,base01))))
     `(diredp-number ((,class (:foreground ,violet))))
     `(diredp-other-priv ((,class (:foreground ,magenta))))
     `(diredp-rare-priv ((,class (:foreground ,magenta))))
     `(diredp-read-priv ((,class (:foreground ,green))))
     `(diredp-write-priv ((,class (:foreground ,red))))
     `(diredp-exec-priv ((,class (:foreground ,cyan))))
     `(diredp-symlink ((,class (:foreground ,orange))))
     `(diredp-link-priv ((,class (:foreground ,orange))))
     `(diredp-autofile-name ((,class (:foreground ,cyan))))
     `(diredp-tagged-autofile-name ((,class (:foreground ,cyan))))
;;;;; dropdown
...
;;;;; icicle
     `(icicle-whitespace-highlight               ((,class (:background ,yellow))))
     `(icicle-special-candidate                  ((,class (:foreground ,base0))))
     `(icicle-extra-candidate                    ((,class (:foreground ,base0))))
     `(icicle-search-main-regexp-others          ((,class (:foreground ,yellow))))
     `(icicle-search-current-input               ((,class (:foreground ,magenta))))
     `(icicle-search-context-level-8             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-7             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-6             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-5             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-4             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-3             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-2             ((,class (:foreground ,violet))))
     `(icicle-search-context-level-1             ((,class (:foreground ,violet))))
     `(icicle-search-main-regexp-current         ((,class (:foreground ,base0))))
     `(icicle-saved-candidate                    ((,class (:foreground ,base0))))
     `(icicle-proxy-candidate                    ((,class (:foreground ,base0))))
     `(icicle-mustmatch-completion               ((,class (:foreground ,green))))
     `(icicle-multi-command-completion           ((,class (:foreground ,base1 :background ,base02))))
     `(icicle-msg-emphasis                       ((,class (:foreground ,blue))))
     `(icicle-mode-line-help                     ((,class (:foreground ,base01))))
     `(icicle-match-highlight-minibuffer         ((,class (:foreground ,magenta))))
     `(icicle-match-highlight-Completions        ((,class (:foreground ,blue))))
     `(icicle-key-complete-menu-local            ((,class (:foreground ,base0))))
     `(icicle-key-complete-menu                  ((,class (:foreground ,base0))))
     `(icicle-input-completion-fail-lax          ((,class (:foreground ,orange))))
     `(icicle-input-completion-fail              ((,class (:foreground ,orange))))
     `(icicle-historical-candidate-other         ((,class (:foreground ,base0))))
     `(icicle-historical-candidate               ((,class (:foreground ,base0))))
     `(icicle-current-candidate-highlight        ((,class (:foreground ,base0 :background ,(if (eq variant 'light) green-lc violet-lc)))))
     `(icicle-Completions-instruction-2          ((,class (:foreground ,base01))))
     `(icicle-Completions-instruction-1          ((,class (:foreground ,base01))))
     `(icicle-completion                         ((,class (:foreground ,yellow))))
     `(icicle-complete-input                     ((,class (:foreground ,magenta))))
     `(icicle-common-match-highlight-Completions ((,class (:foreground ,green))))
     `(icicle-candidate-part                     ((,class (:foreground ,base0))))
     `(icicle-annotation                         ((,class (:foreground ,base01))))
